...
export default function Skills() {
	return (
		<section
			className='home-section flex gap-4 items-center justify-center relative bg-dark-gray text-right'
			id='skills'
		>
			<div className='md:w-1/2'>
				...
				<ul className='flex flex-wrap items-start justify-end gap-3'>
					{allSkills.map((skill, index) => (
						<Link href={skill.link} key={index}>
							<a
								...
								className='flex items-center rounded-xs py-1 px-2 gap-1 min-w-fit cursor-pointer hover:scale-110 transition ease-linear'
							>
								{skill.icon}
