...
I am working part-time as a Frontend Engineer Intern at **[Disecto](https://www.disecto.com/)**. If you have a project that you want to get started, think you need my help with something, or just fancy saying hello, then **[get in touch](#contact)**.
`;
